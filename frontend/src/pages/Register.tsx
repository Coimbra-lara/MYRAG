      ...
      <div className="w-full max-w-md bg-white border border-zinc-200 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-8">
          <div className="space-y-2 text-center mb-8">
            <h1 className="text-2xl font-bold tracking-tight text-zinc-900">Criar sua conta</h1>
            <p className="text-sm text-zinc-500">Preencha seus dados para começar a usar a IA</p>
          </div>
